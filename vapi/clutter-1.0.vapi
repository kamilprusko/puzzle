...
namespace Clutter {
    ...
    public class Actor : GLib.InitiallyUnowned, Clutter.Scriptable {
        ...
        public GLib.List<unowned Action> get_actions ();
        ...
        public GLib.List<unowned Constraint> get_constraints ();
 ...
 */
/*
>         <struct name="ClutterBlurEffectClass">
>         <struct name="ClutterColorizeEffectClass">
>         <struct name="ClutterDesaturateEffectClass">
>         <struct name="ClutterInputDeviceClass">
>         <struct name="ClutterPageTurnEffectClass">
>         <struct name="ClutterPathConstraintClass">
>         <struct name="ClutterSettingsClass">
>         <struct name="ClutterSnapConstraintClass">

>         <enum name="ClutterSnapEdge" type-name="ClutterSnapEdge" get-type="clutter_snap_edge_get_type">
>             <member name="CLUTTER_SNAP_EDGE_TOP" value="0"/>
>             <member name="CLUTTER_SNAP_EDGE_RIGHT" value="1"/>
>             <member name="CLUTTER_SNAP_EDGE_BOTTOM" value="2"/>
>             <member name="CLUTTER_SNAP_EDGE_LEFT" value="3"/>
>         </enum>
...
>         <object name="ClutterClickAction" parent="ClutterAction" type-name="ClutterClickAction" get-type="clutter_click_action_get_type">

>         <object name="ClutterShaderEffect" parent="ClutterOffscreenEffect" type-


*/

        public class Constraint : ActorMeta
        {
        }
        ...
        {
            [CCode (has_construct_function = false)]
            public SnapConstraint (Actor     source,
                                   SnapEdge  from_edge,
                                   SnapEdge  to_edge,
                                   float     offset);
                                   
            public void set_source (Actor source);
        ...
        public class ActorMeta : GLib.InitiallyUnowned
        {
            ...
            public unowned Actor get_actor ();
            public bool get_enabled ();
            public string get_name ();
            public void set_enabled (bool is_enabled);
            public void set_name (string name);
                        
            public virtual void set_actor (Actor actor);
        }
        ...
        public class DragAction : Action
        {
            ...
            public uint x_drag_threshold;
            public uint y_drag_threshold;
        ...
        public enum DragAxis {
            [CCode (cname = "CLUTTER_DRAG_AXIS_NONE")]
            NONE,
            [CCode (cname = "CLUTTER_DRAG_X_AXIS")]
            X,
            [CCode (cname = "CLUTTER_DRAG_Y_AXIS")]
            Y
        }
